...
describe("loadBuiltinCommands", () => {
  ...
  it("should include handoff command in loaded commands", () => {
    //#given
  ...
  it("should exclude handoff when disabled", () => {
    //#given
  ...
  it("should include handoff template content in command template", () => {
  ...
  it("should include session context variables in handoff template", () => {
    //#given - no disabled commands
  ...
  it("should have correct description for handoff", () => {
    //#given - no disabled commands
