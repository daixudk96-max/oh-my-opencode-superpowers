...
} from "./constants"; // TDD-EXEMPT: path migration fix
import type {
	BoulderState,
	PhaseStatus,
	PlanProgress,
...
export function readBoulderState(directory: string): BoulderState | null {
	...
	try {
		...
		return parsed as unknown as BoulderState;
	} catch {
		return null;
	}
}
...
export function upsertTaskSessionState(
	...
	const originalTaskSessions = { ...taskSessions };
	...
	state.task_sessions = originalTaskSessions;
	return null;
}
