...
export function resolveFirstAvailableFallback(fallbackChain, availableModels) {
...
export function isAnyFallbackModelAvailable(fallbackChain, availableModels) {
...
export function isAnyProviderConnected(providers, availableModels) {
