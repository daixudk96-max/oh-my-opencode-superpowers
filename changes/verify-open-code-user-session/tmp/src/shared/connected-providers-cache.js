 ...
 */
export function readConnectedProvidersCache() {
 ...
 */
export function hasConnectedProvidersCache() {
    const cacheFile = getCacheFilePath(CONNECTED_PROVIDERS_CACHE_FILE);
 ...
 */
export function hasProviderModelsCache() {
    const cacheFile = getCacheFilePath(PROVIDER_MODELS_CACHE_FILE);
    return existsSync(cacheFile);
}
/**
 ...
 */
export function writeProviderModelsCache(data) {
    ensureCacheDir();
    const cacheFile = getCacheFilePath(PROVIDER_MODELS_CACHE_FILE);
    const cacheData = {
        ...data,
