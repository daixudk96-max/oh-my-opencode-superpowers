...
function matchesNotificationPlugin(entry) {
    ...
    for (const known of KNOWN_NOTIFICATION_PLUGINS) {
        ...
        if (normalized.startsWith("file://") && (normalized.endsWith(`/${known}`) ||
 ...
 */
export function detectExternalNotificationPlugin(directory) {
 ...
 */
export function getNotificationConflictWarning(pluginName) {
