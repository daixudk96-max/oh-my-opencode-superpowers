...
import { cleanupArchive, downloadArchive, ensureCacheDir, ensureExecutable, extractTarGz as extractTarGzArchive, } from "../../shared/binary-downloader";
...
export async function downloadAndInstallRipgrep() {
    const platformKey = getPlatformKey();
