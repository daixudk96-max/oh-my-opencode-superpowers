...
export async function formatSessionList(sessionIDs) {
...
export async function filterSessionsByDate(sessionIDs, fromDate, toDate) {
    if (!fromDate && !toDate)
        return sessionIDs;
...
export async function searchInSession(sessionID, query, caseSensitive = false, maxResults) {
