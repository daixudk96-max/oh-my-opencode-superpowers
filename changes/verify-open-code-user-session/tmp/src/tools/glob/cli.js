...
import { resolveGrepCli, DEFAULT_TIMEOUT_MS, DEFAULT_LIMIT, DEFAULT_MAX_DEPTH, DEFAULT_MAX_OUTPUT_BYTES, RG_FILES_FLAGS, DEFAULT_RG_THREADS, } from "./constants";
...
export async function runRgFiles(options, resolvedCli) {
