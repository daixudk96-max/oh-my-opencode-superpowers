...
export function toHashlineContent(content) {
    if (!content)
        return content;
...
export function generateUnifiedDiff(oldContent, newContent, filePath) {
    return createTwoFilesPatch(filePath, filePath, oldContent, newContent, undefined, undefined, { context: 3 });
}
export function countLineDiffs(oldContent, newContent) {
