...
export async function resolveSubagentExecution(args, executorCtx, parentAgent, categoryExamples) {
...
Create the work plan directly - that's your job as the planning agent.`,
    ...
    try {
        ...
        const matchedAgent = callableAgents.find((agent) => agent.name.toLowerCase() === agentToUse.toLowerCase()
        ...
        const agentOverride = agentOverrides?.[agentConfigKey]
