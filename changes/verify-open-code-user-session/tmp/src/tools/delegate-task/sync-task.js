...
import { syncTaskDeps } from "./sync-task-deps";
import { setSessionFallbackChain, clearSessionFallbackChain } from "../../hooks/model-fallback/hook";
export async function executeSyncTask(args, ctx, executorCtx, parentContext, agentToUse, categoryModel, systemContent, modelInfo, fallbackChain, deps = syncTaskDeps) {
