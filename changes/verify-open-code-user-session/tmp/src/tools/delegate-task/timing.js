...
export function getDefaultSyncPollTimeoutMs() {
...
export function __resetTimingConfig() {
...
export function __setTimingConfig(overrides) {
    ...
    if (overrides.SESSION_CONTINUATION_STABILITY_MS !== undefined)
        SESSION_CONTINUATION_STABILITY_MS = overrides.SESSION_CONTINUATION_STABILITY_MS;
}
