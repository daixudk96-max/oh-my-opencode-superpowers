...
`;
function renderPlanAgentCategoryRows(categories) {
...
function renderPlanAgentSkillRows(skills) {
...
export function buildPlanAgentSkillsSection(categories = [], skills = []) {
...
export function buildPlanAgentSystemPrepend(categories = [], skills = []) {
    return [
 ...
 */
export function isPlanAgent(agentName) {
    if (!agentName)
        return false;
...
export function isPlanFamily(category) {
    if (!category)
        return false;
