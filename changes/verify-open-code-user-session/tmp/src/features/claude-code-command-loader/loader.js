...
export async function loadProjectCommands(directory) {
...
export async function loadOpencodeGlobalCommands() {
...
export async function loadOpencodeProjectCommands(directory) {
...
export async function loadAllCommands(directory) {
