...
import { getCategoryDescription, buildAgentSelectionSection, buildCategorySection, buildSkillsSection, buildDecisionMatrix, } from "./prompt-section-builder";
const MODE = "all";
/**
 * Determines which Atlas prompt to use based on model.
 */
export function getAtlasPromptSource(model) {
 ...
 */
export function getAtlasPrompt(model) {
...
export function createAtlasAgent(ctx) {
    const baseConfig = {
...
export const atlasPromptMetadata = {
    category: "advisor",
    cost: "EXPENSIVE",
    promptAlias: "Atlas",
    triggers: [
