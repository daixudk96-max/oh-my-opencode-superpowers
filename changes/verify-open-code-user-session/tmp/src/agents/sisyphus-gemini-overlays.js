 ...
 */
export function buildGeminiToolMandate() {
...
export function buildGeminiToolGuide() {
...
export function buildGeminiToolCallExamples() {
...
export function buildGeminiDelegationOverride() {
...
export function buildGeminiVerificationOverride() {
...
export function buildGeminiIntentGateEnforcement() {
