...
Generate to: \`changes/{name}/tasks.md\`
...
- Evidence: changes/{name}/evidence/task-{N}-{slug}.{ext}
...
- [ ] N. {Task Title}
  ...
  **QA Scenarios** (MANDATORY — task incomplete without these):
  ...
  Scenario: [Failure/edge case]
    ...
    Evidence: changes/{name}/evidence/task-{N}-{slug}-error.{ext}
  \\\`\\\`\\\`
...
`;
export function getGptPrometheusPrompt() {
