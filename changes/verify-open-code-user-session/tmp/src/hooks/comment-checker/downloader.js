...
import { cleanupArchive, downloadArchive, ensureCacheDir, ensureExecutable, extractTarGz, extractZipArchive, getCachedBinaryPath as getCachedBinaryPathShared, } from "../../shared/binary-downloader";
 ...
 */
export async function downloadCommentChecker() {
 ...
 */
export async function ensureCommentCheckerBinary() {
    // Check cache first
