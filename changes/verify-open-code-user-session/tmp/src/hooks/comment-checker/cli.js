 ...
 */
export async function getCommentCheckerPath() {
 ...
 */
export function getCommentCheckerPathSync() {
 ...
 */
export async function runCommentChecker(input, cliPath, customPrompt) {
