...
export function createFallbackState(originalModel) {
    return {
        originalModel,
...
export function isModelInCooldown(model, state, cooldownSeconds) {
...
export function findNextAvailableFallback(state, fallbackModels, cooldownSeconds) {
...
export function prepareFallback(sessionID, state, fallbackModels, config) {
