...
import { parseFrontmatter, resolveCommandsInText, resolveFileReferencesInText, sanitizeModelField, getClaudeConfigDir, getOpenCodeConfigDir, } from "../../shared";
import { loadBuiltinCommands } from "../../features/builtin-commands";
import { isMarkdownFile } from "../../shared/file-utils";
import { discoverAllSkills } from "../../features/opencode-skill-loader";
function resolveCommandContent(content, args) {
...
async function findCommand(commandName, options) {
...
async function formatCommandTemplate(cmd, args) {
    ...
    const finalContent = resolvedContent
        .trim()
        .replace(/\$\{user_message\}/g, commandArgs)
        .replace(/\$ARGUMENTS/g, commandArgs);
