...
import { findFirstMessageWithAgentFromSDK, findNearestMessageWithFieldsFromSDK, } from "../../features/hook-message-injector";
 ...
 */
export async function getAgentFromSession(sessionID, directory, client) {
