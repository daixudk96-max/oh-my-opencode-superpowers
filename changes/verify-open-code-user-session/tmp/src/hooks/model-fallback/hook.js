...
const lastToastKey = new Map();
const sessionFallbackChains = new Map();
export function setSessionFallbackChain(sessionID, fallbackChain) {
    if (!sessionID)
        return;
...
export function clearSessionFallbackChain(sessionID) {
    sessionFallbackChains.delete(sessionID);
}
/**
 ...
 */
export function setPendingModelFallback(sessionID, agentName, currentProviderID, currentModelID) {
 ...
 */
export function hasPendingModelFallback(sessionID) {
    const state = pendingModelFallbacks.get(sessionID);
 ...
 */
export function getFallbackState(sessionID) {
