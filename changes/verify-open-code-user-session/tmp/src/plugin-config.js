...
import { log, deepMerge, getOpenCodeConfigDir, addConfigLoadError, parseJsonc, detectConfigFile, migrateConfigFile, } from "./shared";
...
export function loadConfigFromPath(configPath, _ctx) {
    try {
...
export function loadPluginConfig(directory, ctx) {
    ...
    let config = loadConfigFromPath(userConfigPath, ctx) ?? OhMyOpenCodeConfigSchema.parse({});
